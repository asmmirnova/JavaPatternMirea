...
public class ProductController {
    ...
    public String addNewOrder(@ModelAttribute Order order, @ModelAttribute OrderItem orderItems, @AuthenticationPrincipal CustomUserDetails customUserDetails) {
...
//            OrderRepository.save(orderItem);
    ...
    public String getShoppingCart(Model model) {
        ...
        log.info("{} items", numberOfItems.getNumber());
        return "shopping-cart";
    }

    @PostMapping("/shopping-cart-post")
    public String getNumberOfItems(NumberOfItems numberOfItems) {
        this.numberOfItems = numberOfItems;
        log.info("number of items: {}", this.numberOfItems.getNumber());
        return "redirect:/shop";
    }
}